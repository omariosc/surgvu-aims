#!/bin/bash
exec > /users/sc20osc/joblogs/cat1_filter_import.log 2>&1
...
r=urllib.request.Request("https://grand-challenge.org/api/v1/algorithms/images/?algorithm=10d3a54a-7974-425f-a2c2-796762decfc4",
...
n=sorted(res,key=lambda x:str(x.get("created")))[-1]
...
echo "TIMED OUT non-terminal"; exit 1
